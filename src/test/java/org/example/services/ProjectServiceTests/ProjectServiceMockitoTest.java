...
public class ProjectServiceMockitoTest {
    ...
    @Before
    public void setUp() {
        given(projectRepositoryMock.findByProjectName(PROJECT_EXIST_NAME)).willReturn(new ProjectEntity(PROJECT_EXIST_NAME));
        given(projectRepositoryMock.findByProjectName(PROJECT_NON_EXIST_NAME)).willReturn(null);
    ...
    public void checkIfProjectInProgressShouldThrowInvalidStatusException() throws NotFoundException {
        projectService.checkIfProjectInProgress(EXISTING_ID_FOR_BACKLOG_PROJECT);
    }
    ...
    public void checkIfProjectInProgressShouldReturnTrue() throws InvalidStatusException, NotFoundException{
        ...
        assertThat(projectService.checkIfProjectInProgress(EXISTING_ID_FOR_IN_PROGRESS_PROJECT)).isTrue();
    }
    ...
    public void findByProjectNameShouldFindProject() throws NotFoundException {
        ...
        assertThat(project.getProjectName()).isEqualTo(PROJECT_EXIST_NAME);
    }

    @Test(expected = NotFoundException.class)
    public void findByProjectNameShouldThrowNotFoundException() throws NotFoundException {
        ProjectEntity project = projectService.findByProjectName(PROJECT_NON_EXIST_NAME);
